...
class QRScanner extends Component {
  ...
  async onBarCodeRead(scanResult) {
    ...
    console.warn(scanResult.data, this.carduuid);
    this.carduuid = scanResult.data
	...
	if (!this.barcodeCodes.includes(scanResult.data)) {
	  ...
	  console.warn('onBarCodeRead call'); //this saves an array of all the QR Code Values! In this, we store a bunch of cards!
  }
